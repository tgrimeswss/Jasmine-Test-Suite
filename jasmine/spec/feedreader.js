...
$(function () {
    ...
    */
    ...
    describe('Initial Entries', function () {
        ...
        it('has an .entry element after loading', function () {//Test suite to check if there is at least one .entry element after DOM load
    ...
    describe('New Feed Selection', function () {
        ...
        beforeEach(function (done) {
            ...
            loadFeed(0, function () {
                entriesBefore = $('.feed').find("h2").text();//Locate the h2 elements in the feed variable
        ...
        it('changes the content when new feed is loaded', function (done) {//Test suite to check that the feeds loaded after it was empty
            ...
            loadFeed(1, function () {//Call the loadFeed for test data
                ...
                expect(entriesBefore).not.toEqual(entries_after);//Expect the first entries defined above (entriesBefore) to be different than the new entries (entries after)
